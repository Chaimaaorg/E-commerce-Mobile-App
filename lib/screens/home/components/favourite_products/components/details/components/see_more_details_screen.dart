...
class SeeMoreDetailsScreen extends StatelessWidget {
  SeeMoreDetailsScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar:
        const CustomBottomNavBar(selectedMenu: MenuState.favourite, height: 56.0),
        body: Column(
          children: [
            SizedBox(
        ...
        children: [
          ...
          Expanded(
            child: IndexedStack(
              ...
              children: [
                _DescriptionTab(description: SeeMoreDetailsScreen._description, brand: SeeMoreDetailsScreen._brand, reference: SeeMoreDetailsScreen._reference,),
                _FeaturesTab(features: SeeMoreDetailsScreen._features),
                _TechnicalFileTab(pdfPath: 'pdfs/${SeeMoreDetailsScreen._id}/fichetechnique.pdf'),
                _VideoTab(videoId: getVideoIdFromUrl(SeeMoreDetailsScreen._linkVideo!), currentIndex: _selectedTabIndex,),
              ],
            ),
          ),
        ],
...
class _productPic extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ImageContainer(
      ...
      imageUrl: SeeMoreDetailsScreen._image ?? "https://picturesofmaidenhead.files.wordpress.com/2019/01/image-not-found.jpg",
      networkImage: true,
      child: Column(
