...
import 'package:Districap/screens/show_all_products/components/details/components/body.dart';
...
class _DetailsScreenState extends State<DetailsScreen> {
  final GlobalKey _detailsGlobalKey = GlobalKey();
    ...
    return RepaintBoundary(
      ...
      child: Scaffold(
        ...
        body: Body(
          ...
          shareproduct: () => context.read<ShareProvider>().shareProduct(context,_detailsGlobalKey, widget.product),
        ),
