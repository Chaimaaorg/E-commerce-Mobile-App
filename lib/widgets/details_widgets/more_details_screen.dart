...
class MoreDetailsScreen extends StatelessWidget {
  MoreDetailsScreen({Key? key}) : super(key: key);
  static const routeName = '/discover';
  static String? _description, _features, _brand,_reference,_id,_linkVideo;
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar:
            CustomBottomNavBar(selectedMenu: MenuState.home, height: 56.0),
        body: Column(
          children: [
            SizedBox(
        ...
        children: [
          ...
          Expanded(
            child: IndexedStack(
              ...
              children: [
                _DescriptionTab(description: MoreDetailsScreen._description, brand: MoreDetailsScreen._brand, reference: MoreDetailsScreen._reference,),
                _FeaturesTab(features: MoreDetailsScreen._features),
                _TechnicalFileTab(pdfPath: 'pdfs/${MoreDetailsScreen._id}/fichetechnique.pdf'),
                _VideoTab(videoId: getVideoIdFromUrl(MoreDetailsScreen._linkVideo!), currentIndex: _selectedTabIndex,),
              ],
            ),
          ),
        ],
...
class _productPic extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ImageContainer(
      ...
      imageUrl: "assets/images/wireless_headphones.png",
      networkImage: false,
      child: Column(
